...
<head>
 ...
 <body>
   <form action="acc3.php" method="post">
...
if(empty($cren)){
    ...
    echo '<meta http-equiv="refresh" content="0;URL=acc3.php">';
  }
if(empty($date)){
...
?></form>
  <h2 style="color: black;text-align:center">Liste &eacute;tudiants ING3 Info</h2>
...
$link = mysqli_connect("localhost","root","","absence");
 ...
 $select1 = mysqli_query($link, "SELECT nom,prenom FROM etudiant where niveau='ing3'");
